 ...
 * 新闻列表多图适配器
 */
class NewsMultiplePictureAdapter(context: Context, list: List<NewsListEntity.Content.ImageList>?, layoutResId: Int, val imageSize: Int) : CommonAdapter<NewsListEntity.Content.ImageList>(context, list, layoutResId) {

    override fun convertView(viewHolder: ViewHolder, item: NewsListEntity.Content.ImageList, position: Int) {
