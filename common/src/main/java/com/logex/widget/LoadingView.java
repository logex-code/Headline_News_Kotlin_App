...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, DensityUtil.dip2px(context, 24));
        mPaintColor = array.getInt(R.styleable.LoadingView_loading_view_color, 0xff919192);
        array.recycle();
        initPaint();
    }
